...
<head>
    ...
    <!-- Google font-->
    <link href="{{asset('backend')}}/{{asset('backend')}}/css.css?family=Open+Sans:300,400,600,700,800" rel="stylesheet"><link href="{{asset('backend')}}/{{asset('backend')}}/css-1.css?family=Quicksand:500,700" rel="stylesheet">
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/files/bower_components/bootstrap/css/bootstrap.min.css">
    <!-- waves.css -->
    <link rel="stylesheet" href="{{asset('backend')}}/files/assets/pages/waves/css/waves.min.css" type="text/css" media="all"><!-- feather icon --> <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/files/assets/icon/feather/css/feather.css">
    ...
    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="{{asset('backend')}}/files/assets/css/style.css"><link rel="stylesheet" type="text/css" href="{{asset('backend')}}/files/assets/css/pages.css">
</head>
                        ...
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <p class="text-inverse text-left"><a href="{{asset('backend')}}/index.html"><b>Back to website</b></a></p>
                                </div>
                                <div class="col-md-2">
                                    <img src="{{asset('backend')}}/files/assets/images/auth/Logo-small-bottom.png" alt="small-logo.png">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="{{asset('backend')}}/files/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js"></script>
<script type="text/javascript" src="{{asset('backend')}}/files/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js"></script>
